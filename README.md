...
Files in `panels` follow the naming convention `${Volume}-${Chapter}-${Page(s)}-${Panel}.jpg`, e.g. 1-1-22-1.jpg, 2-6-86,87-1.png.  
Files in `pfps` follow a similar naming convention, simply preceded by `BLPpanels`, e.g. BLPpanels-1-1-2,3-1.jpg, BLPpanels-9-34-3,4-6.jpg  
